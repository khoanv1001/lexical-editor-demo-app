...
export default function ImagesPlugin({
      ...
      editor.registerCommand(
        ...
        (payload) => {
          ...
          if (currentCount >= maxImages) {
            console.warn(`Cannot insert image: Maximum of ${maxImages} images allowed`)
            return false
          }
          ...
          if ($isRangeSelection(selection)) {
            ...
            } else if ($isParagraphNode(node) && node.getTextContent() === '') {
  ...
  }, [captionsEnabled, editor, maxImages, onImageCountChange, updateImageCount])
...
export function canInsertImage(editor: LexicalEditor, maxImages: number = MAXIMUM_IMAGE_NODE): boolean {
